...
export default function QuickFilterTabs() {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3.5 pb-6 w-full select-none">
      ...
      <Link 
        href="/explore" 
        className={`flex items-center justify-center gap-2 font-extrabold text-xs sm:text-sm px-3 py-2.5 sm:px-4 sm:py-3 rounded-xl sm:rounded-2xl transition-all shadow-md text-center ${
          isExplore 
