...
- When providing server update instructions, provide simple terminal commands (`git pull`, `npm run build`, `pm2 restart all`) that the user can execute after logging into their Hetzner terminal with password.
